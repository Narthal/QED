...
mkdir GLFW
cd ../
External\Tools\cmake-3.16.2-win64-x64\bin\cmake.exe -S External\Dependencies\GLFW\ -B Build\GLFW\ -DUSE_MSVC_RUNTIME_LIBRARY_DLL=ON  -DCMAKE_BUILD_TYPE=Debug
