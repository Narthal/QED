			...
			namespace OpenGL
			{
				OpenGLShader::OpenGLShader(const std::string& vertexSource, const std::string& fragmentSource)
				{
					...
					if (isCompiled == GL_FALSE)
					{
						...
						LOG << "Vertex shader compillation failure : " << Core::Log::Severity::Error << infoLog.data();
					...
					if (isCompiled == GL_FALSE)
					{
						...
						// Use the infoLog as you see fit.
						LOG << "Fragment shader compillation failure : " << Core::Log::Severity::Error << infoLog.data();
